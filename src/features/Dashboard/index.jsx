...
import { useGetAllMoviesQuery } from "../../services/Redux/MovieDbSlice";

const Dashboard = () => {
  const { InputSearch, Data, setData, MovieSearchRes } =
    useContext(GlobalContext);

  const { page } = useSelector((state) => state.Pagination);

  const { data, isSuccess, isFetching } = useGetAllMoviesQuery(
